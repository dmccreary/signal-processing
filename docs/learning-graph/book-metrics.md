...
| Equations | 1564 | 1543 | LaTeX expressions (inline and display) |
| Total Words | 130,048 | 66,396 | Words in markdown files |
| Links | 537 | 195 | Hyperlinks in markdown format |
| Equivalent Pages | 541 | 287 | Estimated pages (250 words/page + visuals) |
