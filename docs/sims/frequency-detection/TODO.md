...
**MicroSim:** frequency-detection
**Repository:** signal-processing
...
- **Framework:** p5.js
- **Detected subjects:** Mathematics, Computer Science, Engineering
- **Visualization types:** simulation, graph, interactive-demo, map
- **Has main.html:** No
- **Has index.md:** Yes
