...
function drawFrequencySpectrum() {
  ...
  // Only show frequency range up to 2000 Hz
...
function createControls() {
  ...
  // Frequency slider (0-2000 Hz)
  frequencySlider = createSlider(0, 2000, currentFreq, 10);
